export const translations = {
  en: {
    ...
    "education.institution_required": "Please enter an institution name",
    "education.degree": "Degree",
    "education.degree_required": "Please enter a degree",
    "education.field_of_study": "Field of Study",
    "education.location": "Location",
    "education.start_date": "Start Date",
    "education.end_date": "End Date",
    "education.from_date": "From",
    "education.to_date": "To",
    "education.from_date_help": "When did you start attending this institution?",
    "education.to_date_help": "When did you complete or leave this institution?",
    ...
    "education.level_label": "Select your highest level of education:",
    "education.select_level": "Select level...",
    "education.level_required": "Required",
    "education.college_title": "College Education Details",
    "education.college_intro": "Please provide details about your college education.",
    "education.college_required": "At least one degree required",
    "education.level_less_than_high_school": "Less than High School",
    "education.level_high_school": "High School or GED",
    "education.level_some_college": "Some College (no degree)",
    "education.level_associates": "Associate's Degree",
    "education.level_bachelors": "Bachelor's Degree",
    "education.level_masters": "Master's Degree",
    "education.level_doctorate": "Doctorate (PhD, EdD, etc.)",
    "education.level_professional": "Professional Degree (MD, JD, etc.)",
    ...
    "residence.select_country": "Select Country",
    ...
    "employment.select_country": "Select Country",
    "employment.city": "City",
    "employment.state_province": "State/Province",
    "employment.select_state": "Select State/Province",
    "employment.description": "Description",
    "employment.contact_section": "Contact Information for Verification",
    "employment.contact": "Contact",
    "employment.contact_name": "Contact Name",
    "employment.contact_type": "Contact Type",
    "employment.select_contact_type": "Select Contact Type",
    "employment.contact_type_manager": "Manager",
    "employment.contact_type_hr": "HR Representative",
    "employment.contact_type_colleague": "Colleague",
    "employment.contact_type_other": "Other",
    "employment.contact_email": "Contact Email",
    "employment.contact_phone": "Contact Phone",
    "employment.contact_preferred_method": "Preferred Contact Method",
    "employment.select_contact_method": "Select Preferred Method",
    "employment.contact_method_email": "Email",
    "employment.contact_method_phone": "Phone",
    "employment.start_date": "Start Date",
    "employment.end_date": "End Date",
    "employment.from_date": "From",
    "employment.to_date": "To",
    "employment.from_date_help": "When did you start working here?",
    "employment.from_date_help_unemployed": "When did this period of unemployment begin?",
    "employment.from_date_help_education": "When did you start studying here?",
    "employment.from_date_help_other": "When did this period begin?",
    "employment.to_date_help": "When did you leave this job?",
    "employment.to_date_help_unemployed": "When did this period of unemployment end?",
    "employment.to_date_help_education": "When did you finish studying here?",
    "employment.to_date_help_other": "When did this period end?",
    "employment.is_current_job": "I currently work here",
    "employment.is_current_unemployed": "I am currently unemployed",
    ...
    "employment.contact_email_placeholder": "Email address",
    "employment.contact_phone_placeholder": "Phone number",
    "employment.company_required": "Please enter a company name",
    "employment.position_required": "Please enter a position title",
    "employment.country_required": "Please select a country",
    "employment.city_required": "Please enter a city",
    "employment.state_required": "Please select a state/province",
    "employment.type_required": "Please select an employment type",
    "employment.contact_name_required": "Please enter a contact name",
  ...
  es: {
    ...
    "education.institution_required": "Por favor ingrese el nombre de la institución",
    "education.degree": "Título",
    "education.degree_required": "Por favor ingrese un título",
    ...
    "education.from_date": "Desde",
    "education.to_date": "Hasta",
    "education.from_date_help": "¿Cuándo comenzó a asistir a esta institución?",
    "education.to_date_help": "¿Cuándo completó o dejó esta institución?",
    ...
    "education.level_title": "Nivel Más Alto de Educación",
    "education.level_label": "Seleccione su nivel más alto de educación:",
    "education.select_level": "Seleccionar nivel...",
    "education.level_required": "Requerido",
    "education.college_title": "Detalles de Educación Universitaria",
    "education.college_intro": "Por favor proporcione detalles sobre su educación universitaria.",
    "education.college_required": "Al menos un título requerido",
    "education.level_less_than_high_school": "Menos que Secundaria",
    "education.level_high_school": "Secundaria o GED",
    "education.level_some_college": "Algo de Universidad (sin título)",
    "education.level_associates": "Título de Asociado",
    "education.level_bachelors": "Licenciatura",
    "education.level_masters": "Maestría",
    "education.level_doctorate": "Doctorado (PhD, EdD, etc.)",
    "education.level_professional": "Título Profesional (MD, JD, etc.)",
    ...
    "residence.select_country": "Seleccionar País",
    ...
    "employment.select_state": "Seleccionar Estado/Provincia",
    "employment.description": "Descripción",
    "employment.contact_section": "Información de Contacto para Verificación",
    "employment.contact": "Contacto",
    "employment.contact_name": "Nombre de Contacto",
    "employment.contact_type": "Tipo de Contacto",
    "employment.select_contact_type": "Seleccionar Tipo de Contacto",
    "employment.contact_type_manager": "Gerente",
    "employment.contact_type_hr": "Representante de RRHH",
    "employment.contact_type_colleague": "Colega",
    "employment.contact_type_other": "Otro",
    "employment.contact_email": "Correo Electrónico de Contacto",
    "employment.contact_phone": "Teléfono de Contacto",
    "employment.contact_preferred_method": "Método de Contacto Preferido",
    "employment.select_contact_method": "Seleccionar Método Preferido",
    "employment.contact_method_email": "Correo Electrónico",
    "employment.contact_method_phone": "Teléfono",
    "employment.start_date": "Fecha de Inicio",
    "employment.end_date": "Fecha de Finalización",
    "employment.from_date": "Desde",
    "employment.to_date": "Hasta",
    "employment.from_date_help": "¿Cuándo empezaste a trabajar aquí?",
    "employment.from_date_help_unemployed": "¿Cuándo comenzó este período de desempleo?",
    "employment.from_date_help_education": "¿Cuándo empezaste a estudiar aquí?",
    "employment.from_date_help_other": "¿Cuándo comenzó este período?",
    "employment.to_date_help": "¿Cuándo dejaste este trabajo?",
    "employment.to_date_help_unemployed": "¿Cuándo terminó este período de desempleo?",
    "employment.to_date_help_education": "¿Cuándo terminaste de estudiar aquí?",
    "employment.to_date_help_other": "¿Cuándo terminó este período?",
    "employment.is_current_job": "Trabajo aquí actualmente",
    "employment.is_current_unemployed": "Actualmente estoy desempleado",
    ...
    "employment.contact_email_placeholder": "Dirección de correo electrónico",
    "employment.contact_phone_placeholder": "Número de teléfono",
    "employment.company_required": "Por favor ingrese un nombre de empresa",
    "employment.position_required": "Por favor ingrese un título de posición",
    "employment.country_required": "Por favor seleccione un país",
    "employment.city_required": "Por favor ingrese una ciudad",
    "employment.state_required": "Por favor seleccione un estado/provincia",
    "employment.type_required": "Por favor seleccione un tipo de empleo",
    "employment.contact_name_required": "Por favor ingrese un nombre de contacto",
  ...
  fr: {
    ...
    "education.institution_required": "Veuillez entrer le nom de l'institution",
    "education.degree": "Diplôme",
    "education.degree_required": "Veuillez entrer un diplôme",
    ...
    "education.from_date": "De",
    "education.to_date": "À",
    "education.from_date_help": "Quand avez-vous commencé à fréquenter cette institution?",
    "education.to_date_help": "Quand avez-vous terminé ou quitté cette institution?",
    ...
    "education.level_title": "Niveau d'Éducation le Plus Élevé",
    "education.level_label": "Sélectionnez votre niveau d'éducation le plus élevé:",
    "education.select_level": "Sélectionner un niveau...",
    "education.level_required": "Requis",
    "education.college_title": "Détails de l'Éducation Universitaire",
    "education.college_intro": "Veuillez fournir des détails sur votre éducation universitaire.",
    "education.college_required": "Au moins un diplôme requis",
    "education.level_less_than_high_school": "Inférieur au Lycée",
    "education.level_high_school": "Lycée ou Équivalent",
    "education.level_some_college": "Quelques Études Universitaires (sans diplôme)",
    "education.level_associates": "Diplôme d'Associé",
    "education.level_bachelors": "Licence",
    "education.level_masters": "Master",
    "education.level_doctorate": "Doctorat (PhD, EdD, etc.)",
    "education.level_professional": "Diplôme Professionnel (MD, JD, etc.)",
    ...
    "residence.select_country": "Sélectionner un pays",
  ...
  it: {
    ...
    "residence.select_country": "Seleziona Paese",
    ...
    "timeline.gap": "Écart dans l'historique",
    "timeline.gap_description": "Écart dans l'historique ({{percentage}}% della timeline)",
    "common.present": "Presente"
  }
} as const;
